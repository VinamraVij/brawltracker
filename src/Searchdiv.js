...
class Searchdiv extends Component{
    ...
    renderSearchButton(){
        if(!this.state.displayLoading){
            return (
                <Button onClick={this.onSearchPress} icon={<SearchOutlined />} className="search-mid-div-btn"/>
            )
        }else{            
            return (                
        ...
        return(
            <div className="mid-div">
                <div className="enter-player-tag">
                        Enter Player Tag to track
                        
                </div>
                <div className="brawl-image-div"/>
                <div className="search-mid-div">
                    <input value={this.state.playerTag} className="search-mid-div-input" onChange={(event)=>{
                        this.setState({
